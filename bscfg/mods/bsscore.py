...
import bsInternal
import bsScoreSet
from bsScoreSet import *
from bsScoreSet import PlayerScoredMessage, ScoreSet

betrayLimit = 5

class NewScoreSet(ScoreSet):
...
bs.ScoreSet = NewScoreSet
bsScoreSet.ScoreSet = NewScoreSet
