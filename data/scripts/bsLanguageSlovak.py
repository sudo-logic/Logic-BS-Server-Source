...
values = {
    ...
    'achievementChallengesText':'Výzvy',
    'achievementText':'Achievement',
    'achievements':{
        'Boom Goes the Dynamite':{
            'description':'Odstráň troch nepriateľov pomocou TNT',
            'descriptionComplete':'Odstránenie troch nepriateľov pomocou TNT',
            'descriptionFull':'Odstráň troch nepriateľov pomocou TNT v ${LEVEL}',
            'descriptionFullComplete':'Odstránenie troch nepriateľov pomocou TNT v ${LEVEL}',
            'name':'Bombastická trojka'
        },
        'Boxer':{
            'description':'Vyhraj bez použitia bomby',
            'descriptionComplete':'Výhra bez použitia bomby',
            'descriptionFull':'Vyhraj ${LEVEL} bez použitia bomby',
            'descriptionFullComplete':'Výhra v ${LEVEL} bez použitia bomby',
            'name':'Boxer'
        },
        'Dual Wielding':{
            'descriptionFull':'Pripojiť 2 ovládače (hardvérový nebo aplikácii)',
        ...
        'Flawless Victory':{
            ...
            'name':'Bezchybné víťazstvo'
        },
        'Free Loader':{
            'descriptionFull':'Zapni všetci-proti-všetkým hru s 2+ hráčema',
            'descriptionFullComplete':'Zapnutá hra všetci-proti-všetkým s 2+ hráčmi',
            'name':'Free Loader'
        },
        'Gold Miner':{
            'description':'Odstráň šiestich nepriateľov pomocou mín',
            'descriptionComplete':'Odstránenie šiestich nepriateľov pomocou mín',
            'descriptionFull':'Odstráň šiestich nepriateľov pomocou mín v ${LEVEL}',
            'descriptionFullComplete':'Odstránenie šiestich nepriateľou pomocou mín v ${LEVEL}',
            'name':'Zlatokopka'
        },
        'Got the Moves':{
            'description':'Vyhraj bez použitia boxovania a bômb',
            'descriptionComplete':'Výhra bez použitia boxovania a bômb',
            'descriptionFull':'Vyhraj v ${LEVEL} bez použitia boxovania a bômb',
            'descriptionFullComplete':'Výhra v ${LEVEL} bez použitia boxovania a bômb',
            'name':'Tancuj, tancuj vykrúcaj!'
        },
        'In Control':{
            'descriptionFull':'Pripojte ovládač (hardware alebo aplikáciu)',
        ...
        'Mine Games':{
            'description':'Odstráň troch nepriateľov pomocou mín',
            'descriptionComplete':'Odstránenie troch nepriateľov pomocou mín',
            'descriptionFull':'Odstráň troch nepriateľov pomocou mín v ${LEVEL}',
            'descriptionFullComplete':'Odstránenie troch nepriateľov v ${LEVEL}',
            'name':'Míny z plastelíny'
        },
        'Off You Go Then':{
            'description':'Zhoď troch nepriateľov cez okraj',
            'descriptionComplete':'Zhodenie troch nepriateľov cez okraj',
            'descriptionFull':'Zhoď troch nepriateľov cez okraj v ${LEVEL}',
            'descriptionFullComplete':'Zhodenie troch nepriateľov cez okraj v ${LEVEL}',
            'name':'Chcem ťa nosiť na rukách'
        },
        'Onslaught God':{
        ...
        'Onslaught Training Victory':{
            'description':'Poraz všetkých nepriateľov',
            'descriptionComplete':'Porazenie všetkých nepriateľov',
            'descriptionFull':'Poraz všetkých nepriateľov v ${LEVEL}',
            'descriptionFullComplete':'Porazenie všetkých nepriateľov v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Onslaught Wizard':{
            'description':'Nahraj 1000 bodov',
            'descriptionComplete':'Nahraných 1000 bodov',
            'descriptionFull':'Nahraj 100 bodov v ${LEVEL}',
            'descriptionFullComplete':'Nahraných 1000 bodov v ${LEVEL}',
            'name':'${LEVEL} Čarodej'
        },
        'Precision Bombing':{
            'description':'Vyhraj bez vylepšení',
            'descriptionComplete':'Výhra bez vylepšení',
            'descriptionFull':'Vyhraj ${LEVEL} bez vylepšení',
            'descriptionFullComplete':'Výhra v ${LEVEL} bez vylepšení',
            'name':'Precízne bombardovanie'
        },
        'Pro Boxer':{
        ...
        'Pro Football Shutout':{
            'description':'Poraz súpera na nulu',
            'descriptionComplete':'Porazenie súpera na nulu',
            'descriptionFull':'Poraz súpera na nulu v ${LEVEL}',
            'descriptionFullComplete':'Poraz súpera na nulu v ${LEVEL}',
            'name':'${LEVEL} Debakel'
        },
        ...
        'Pro Onslaught Victory':{
            'description':'Poraz všetky nepriateľské vlny',
            'descriptionComplete':'Porazenie všetkých nepriateľských vĺn',
            'descriptionFull':'Poraz všetky vlny nepriateľov v ${LEVEL}',
            'descriptionFullComplete':'Porazené všetky vlny nepriateľov v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Pro Runaround Victory':{
            'description':'Prejdi všetkými nepriateľskými vlnami',
            'descriptionComplete':'Prejdenie všetkých nepriateľských vĺn',
            'descriptionFull':'Prejdi všetkými nepriateľské vlny v ${LEVEL}',
            'descriptionFullComplete':'Prejdené všetky nepriateľské vlny v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Rookie Football Shutout':{
            'description':'Vyhraj, aniž by si dostal touchdown.',
            'descriptionComplete':'Vyhraj bez toho, aby zláči skórovali',
            'descriptionFull':'Vyhraj ${LEVEL} bez toho, aby zláči skórovali',
            'descriptionFullComplete':'Vyhrajte ${LEVEL} bez toho, aby zlí ľudia skórovali',
            'name':'${LEVEL} Shutout'
        },
        'Rookie Football Victory':{
            'description':'Vyhrajte hru',
            'descriptionComplete':'Vyhrajte hru',
            'descriptionFull':'Vyhrajte hru v ${LEVEL}',
            'descriptionFullComplete':'Vyhral si hru v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Rookie Onslaught Victory':{
            'description':'Poraz všetky kolá',
            'descriptionComplete':'Porazené všetky kolá',
            'descriptionFull':'Porazte všetky kolá v ${LEVEL}',
            'descriptionFullComplete':'Porazené všetky kolá v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Runaround God':{
            'description':'Skóruj 2000 bodov.',
            'descriptionComplete':'Skórujte 2000 bodov',
            'descriptionFull':'Skórujte 2000 bodov na ${LEVEL}',
            'descriptionFullComplete':'Skóruj 2000 bodov v ${LEVEL}',
            'name':'${LEVEL} Boh'
        },
        'Runaround Master':{
            'description':'Skórujte 500 bodov',
            'descriptionComplete':'Skórovaných 500 bodov',
            'descriptionFull':'Skórujte 500 bodov v ${LEVEL}',
            'descriptionFullComplete':'Skóruj 500 bodov v ${LEVEL}',
            'name':'${LEVEL} Majster'
        },
        'Runaround Wizard':{
            'description':'Skórujte 1000 bodov',
            'descriptionComplete':'Skórovaných 1000 bodov',
            'descriptionFull':'Skórujte 1000 bodov na ${LEVEL}',
            'descriptionFullComplete':'Skórovaných 1000 bodov na ${LEVEL}',
            'name':'${LEVEL} Kúzolník'
        },
        'Sharing is Caring':{
            'descriptionFull':'Úspešne zdieľajte hru s priateľom',
            'descriptionFullComplete':'Úspešne zdieľaná hra s priateľom',
            'name':'Sharing is Caring'
        },
        'Stayin\' Alive':{
            'description':'Vyhraj bez toho, aby si zomrel.',
            'descriptionComplete':'Vyhrajte bez úmrtia',
            'descriptionFull':'Vyhrajte ${LEVEL} bez úmrtia',
            'descriptionFullComplete':'Vyhratý ${LEVEL} bez úmrtia',
            'name':'Stayin\' Alive'
        },
        'Super Mega Punch':{
            'description':'Spôsobte 100% damageu jedným úderom',
            'descriptionComplete':'Spôsobených 100% damageu jedným úderom',
            'descriptionFull':'Spôsobte 100% damageu jedným úderom v ${LEVEL}',
            'descriptionFullComplete':'Spôsobených 100% damageu jedným úderom v ${LEVEL}',
            'name':'Super Mega Úder'
        },
        'Super Punch':{
            'description':'Spôsobte 50% damageu jedným úderom',
            'descriptionComplete':'Spôsobených 50% damageu jedným úderom',
            'descriptionFull':'Spôsobte 50%damageu jedným úderom v ${LEVEL}',
            'descriptionFullComplete':'Spôsobených 50% damageu jedným úderom v ${LEVEL}',
            'name':'Super Úder'
        },
        'TNT Terror':{
            'description':'Zabite 6 protivníkov TNT',
            'descriptionComplete':'Zabitých 6 protivníkov s TNT',
            'descriptionFull':'Zabite 6 protivníkov s TNT na ${LEVEL}',
            'descriptionFullComplete':'zabitých 6 protivníkov s TNT na ${LEVEL}',
            'name':'TNT teror.'
        },
        'Team Player':{
        ...
        'The Great Wall':{
            ...
            'descriptionComplete':'Zastavený každý zlý človek',
            'descriptionFull':'Zastavte každého protivníka na ${LEVEL}',
            'descriptionFullComplete':'Zastavený každý protivník na ${LEVEL}',
            'name':'Veľká Stena'
        },
        'The Wall':{
            'description':'Zastavte každého protivníka',
            'descriptionComplete':'Zastavený každý protivník',
            'descriptionFull':'Zastav všetkých protivníkov na ${LEVEL}',
            'descriptionFullComplete':'Zastavený každý protivník na ${LEVEL}',
            'name':'Stena'
        },
        'Uber Football Shutout':{
            'description':'Vyhrajte bez toho, aby ste nechali skóre',
            'descriptionComplete':'Vyhraj bez toho, aby skórovali protivníci',
            'descriptionFull':'Vyhraj ${LEVEL} bez toho, aby skórovali protivníci',
            'descriptionFullComplete':'Vyhrali ste ${LEVEL} bez toho, aby protivníci skórovali',
            'name':'${LEVEL} Obrana'
        },
        'Uber Football Victory':{
            'description':'Vyhraj hru',
            'descriptionComplete':'Vyhral si hru',
        ...
        'Uber Onslaught Victory':{
            ...
            'descriptionComplete':'Porazil si všetky vlny',
            'descriptionFull':'Poraz všetky vlny v ${LEVEL}',
            'descriptionFullComplete':'Porazil si všetky vlny v ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        },
        'Uber Runaround Victory':{
            'description':'Dokonči všetky vlny',
            'descriptionComplete':'Dokonči všetky vlny.',
            'descriptionFull':'Dokonči všetky vlny na ${LEVEL}',
            'descriptionFullComplete':'Dokončil si všetky vlny na ${LEVEL}',
            'name':'${LEVEL} Víťazstvo'
        }
    },
    ...
    'creditsWindow':{
        ...
        'softwareBasedOnText':'Tento softvér je založený z časti na práci človeka ${NAME}',
        ...
        'thanksEspeciallyToText':'Vďaka hlavne človekovi ${NAME}',
    ...
    'helpWindow':{
        ...
        'orPunchingSomethingText':'Alebo mlátil do niečoho, zhodil dačo z útesu, a odpálil to na ceste dole sticky bombou.',
    ...
    'replayRenameWarningText':'Premenuj "${REPLAY}" po hre ak ho chceš; inak bude odstránený.',
    ...
    'store':{
        ...
        'howToUseIconsText':'(vytvor si globálny profil (v okne Účet) aby si ich mohol použiť)',
    ...
    'storeText':'Obchod',
    'submitText':'Poslať',
    'submittingPromoCodeText':'Posielam Kód...',
    ...
    'translations':{
        ...
        'coopLevelNames':{
            ...
            'Uber Runaround':'Extrémny Runaround'
        },
        'gameDescriptions':{
    ...
    'tutorial':{
        ...
        'randomName2Text':'Oliver',
        'randomName3Text':'Baltazár',
        'randomName4Text':'Marek',
